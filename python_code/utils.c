...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "python_code.utils",
        "sources": [
            "utils.pyx"
        ]
    },
    "module_name": "python_code.utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__python_code__utils
#define __PYX_HAVE_API__python_code__utils
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'python_code.utils' */
static float __pyx_v_11python_code_5utils_EPSILON_DBL;
static float __pyx_v_11python_code_5utils_PERPLEXITY_TOLERANCE;
static PyObject *__pyx_f_11python_code_5utils__binary_search_perplexity(PyArrayObject *, PyArrayObject *, float, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "python_code.utils"
extern int __pyx_module_is_main_python_code__utils;
int __pyx_module_is_main_python_code__utils = 0;

/* Implementation of 'python_code.utils' */
...
static PyObject *__pyx_pf_11python_code_5utils__binary_search_perplexity(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_affinities, PyArrayObject *__pyx_v_neighbors, float __pyx_v_desired_perplexity, int __pyx_v_verbose); /* proto */
static PyObject *__pyx_tuple_;
static PyObject *__pyx_tuple__2;
/* Late includes */

/* "python_code/utils.pyx":13
 * 
...
static PyObject *__pyx_pw_11python_code_5utils_1_binary_search_perplexity(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11python_code_5utils__binary_search_perplexity(PyArrayObject *__pyx_v_affinities, PyArrayObject *__pyx_v_neighbors, float __pyx_v_desired_perplexity, int __pyx_v_verbose, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  __pyx_pybuffernd_neighbors.rcbuffer = &__pyx_pybuffer_neighbors;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_affinities.rcbuffer->pybuffer, (PyObject*)__pyx_v_affinities, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_neighbors.rcbuffer->pybuffer, (PyObject*)__pyx_v_neighbors, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
 ...
 */
  __pyx_t_6 = __Pyx_PyInt_From_long(__pyx_v_n_samples); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
 ...
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, __pyx_t_6); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 * 
 */
        __pyx_v_sum_Pi = __pyx_v_11python_code_5utils_EPSILON_DBL;
 ...
 * 
 */
      __pyx_t_1 = ((fabs(__pyx_v_entropy_diff) <= __pyx_v_11python_code_5utils_PERPLEXITY_TOLERANCE) != 0);
      if (__pyx_t_1) {

        /* "python_code/utils.pyx":106
 * 
 *             if math.fabs(entropy_diff) <= PERPLEXITY_TOLERANCE:
 *                 break             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_B.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_B.diminfo[0].strides) = __pyx_v_beta;

    /* "python_code/utils.pyx":124
 *         B[i] = beta
 * 
 *         if verbose and ((i + 1) % 1000 == 0 or i + 1 == n_samples):             # <<<<<<<<<<<<<<
 ...
 *     if verbose:
 */
      __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_i + 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 126, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_6 = __Pyx_PyInt_From_long(__pyx_v_n_samples); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 126, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      ...
      __pyx_t_2 = 0;
      __pyx_t_6 = 0;
      __pyx_t_6 = __Pyx_PyString_Format(__pyx_kp_s_t_SNE_Computed_conditional_prob, __pyx_t_4); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 126, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      if (__Pyx_PrintOne(0, __pyx_t_6) < 0) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
    ...
    __pyx_t_4 = PyFloat_FromDouble(sqrt((__pyx_v_n_samples / __pyx_v_beta_sum))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 130, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = __Pyx_PyString_FormatSafe(__pyx_kp_s_t_SNE_Mean_sigma_f, __pyx_t_6); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 130, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("python_code.utils._binary_search_perplexity", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_B.rcbuffer->pybuffer);
...
static PyObject *__pyx_pw_11python_code_5utils_1_binary_search_perplexity(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_binary_search_perplexity (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_neighbors)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_binary_search_perplexity", 1, 4, 4, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_desired_perplexity)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_binary_search_perplexity", 1, 4, 4, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_verbose)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_binary_search_perplexity", 1, 4, 4, 3); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_binary_search_perplexity") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_desired_perplexity = __pyx_PyFloat_AsFloat(values[2]); if (unlikely((__pyx_v_desired_perplexity == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_verbose = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_verbose == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_binary_search_perplexity", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("python_code.utils._binary_search_perplexity", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_affinities), __pyx_ptype_5numpy_ndarray, 1, "affinities", 0))) __PYX_ERR(0, 14, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_neighbors), __pyx_ptype_5numpy_ndarray, 1, "neighbors", 0))) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_r = __pyx_pf_11python_code_5utils__binary_search_perplexity(__pyx_self, __pyx_v_affinities, __pyx_v_neighbors, __pyx_v_desired_perplexity, __pyx_v_verbose);
...
static PyObject *__pyx_pf_11python_code_5utils__binary_search_perplexity(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_affinities, PyArrayObject *__pyx_v_neighbors, float __pyx_v_desired_perplexity, int __pyx_v_verbose) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_affinities;
  __Pyx_Buffer __pyx_pybuffer_affinities;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_neighbors;
  __Pyx_Buffer __pyx_pybuffer_neighbors;
  ...
  __pyx_pybuffernd_neighbors.diminfo[0].strides = __pyx_pybuffernd_neighbors.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_neighbors.diminfo[0].shape = __pyx_pybuffernd_neighbors.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_neighbors.diminfo[1].strides = __pyx_pybuffernd_neighbors.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_neighbors.diminfo[1].shape = __pyx_pybuffernd_neighbors.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_11python_code_5utils__binary_search_perplexity(__pyx_v_affinities, __pyx_v_neighbors, __pyx_v_desired_perplexity, __pyx_v_verbose, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"_binary_search_perplexity", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11python_code_5utils_1_binary_search_perplexity, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11python_code_5utils__binary_search_perplexity},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_python_code__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "python_code.utils")) {
      if (unlikely(PyDict_SetItemString(modules, "python_code.utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_v_11python_code_5utils_EPSILON_DBL = 1e-8;

  /* "python_code/utils.pyx":10
 * 
 * cdef float EPSILON_DBL = 1e-8
 * cdef float PERPLEXITY_TOLERANCE = 1e-5             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
  __pyx_v_11python_code_5utils_PERPLEXITY_TOLERANCE = 1e-5;

  /* "python_code/utils.pyx":1
 * from libc cimport math             # <<<<<<<<<<<<<<
 * cimport cython
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init python_code.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init python_code.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
