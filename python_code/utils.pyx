...
cpdef tuple _binary_search_perplexity(
    ...
    B : array, shape (n_samples)
        Scaling factors beta_i = 1 / (2*sigma_i**2) containing the sigma values of the Gaussian.
    """
    ...
    cdef np.ndarray[np.float64_t, ndim=1] B = np.zeros(
